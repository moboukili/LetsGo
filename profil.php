        ...
        <div class="wrap">
            <div class="row">
                ...
                <div class="content one-half modal">
                    <?php    
                            ...
                            <div class="alert">
                              ...
                              <img src="images/verified.png">&nbsp;&nbsp; You have updated your profile.
                            </div> 
                            <?php
                            }
                        }
                    ?>
                    <br><h2>Personal informations. </h2>  
                    <div class="box">
                         <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <div class="f-row">
                                <div class="full-width">
                                    <input type="submit" name="update" value="Save" class="btn color medium" />
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <aside class="one-fourth sidebar right">
                    ...
                    <div class="widget">
                       <ul class="categories">
                            <li class="active"><a href="profil.php">Personal informations</a></li>
