...
<html>
  <head>
	...
	<title>Search results  | Let'sGo </title>
					...
					<?php 
							...
							<div class="one-fourth heightfix">
									<br>
										...
										<p>&nbsp;&nbsp;Phone : <strong> <?php echo htmlspecialchars($row["phone"]); ?></strong></p> <br />
										<?php if($row["drive"]== 0)  {
	                                     }else{ ?>
										<p>&nbsp;&nbsp;car marque : <strong> <?php echo htmlspecialchars($row["drive"]); }?></strong></p> <br />
							...
							<div class="one-half heightfix">
								...
								<ul>
									<li>
										...
										<p>Max <strong><?php echo htmlspecialchars($row["seats"]);?></strong> <br />per vehicle</p>
									</li>
									<li>
										<span class="ico luggage"></span>
										<p>Max <strong><?php echo htmlspecialchars($row["luggage"]);?></strong> <br />per vehicle</p>
									</li>
									<li>
							...
							<div class="one-fourth heightfix">
								<div>
									<h3><?php echo htmlspecialchars($row["pickup"]);?><br /><small>to</small><br />
