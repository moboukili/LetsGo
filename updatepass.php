...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["new_password"]))){
        $new_password_err = '<span class="error_message">Please enter the new password.</span>';     
    } elseif(strlen(trim($_POST["new_password"])) < 6){
        $new_password_err = '<span class="error_message">Password must have atleast 6 characters.</span>';
    } else{
    ...
    if(empty(trim($_POST["confirm_password"]))){
        $confirm_password_err = '<span class="error_message">Please confirm the password.</span>';
    } else{
    ...
    if(empty($new_password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($con, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                session_destroy();
                $message = 'your new password is correct.';
...
<html>
  <head>
    ...
    <title>My password | Let'sGo </title>
                         ...
                         <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <div class="f-row">
                                <div class="full-width <?php echo (!empty($new_password_err)) ? 'has-error' : ''; ?>">
                                    <input type="password" placeholder="New Password " name="new_password" value="<?php echo $new_password; ?>"/><br>
                ...
                <aside class="one-fourth sidebar right">
                    ...
                    <div class="widget">
                       <ul class="categories">
                            ...
                            <li class="active"><a href="updatepass.php">Password</a></li>
